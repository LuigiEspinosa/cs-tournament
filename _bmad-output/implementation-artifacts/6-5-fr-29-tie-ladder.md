...
cases and 18 refusals proved byte-identical structurally: 489 insertions against 1 deletion, and that
deletion is `"internal"` gaining a comma for the appended `"ladder"`) · pgTAP **1155 across 25 files,
